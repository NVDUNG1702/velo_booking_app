...
export default function ToastItemComponent({ text1, text2, type }: ToastItemProps) {
    ...
    return (
        <View style={{ width: '90%', minHeight: 60, padding: 10, borderRadius: 6, borderStartWidth: 4, borderColor: borderColor, backgroundColor: isDarkMode ? '#rgba(64, 64, 64, 0.5)' : 'rgba(230, 230, 230, 0.5)' }}>
